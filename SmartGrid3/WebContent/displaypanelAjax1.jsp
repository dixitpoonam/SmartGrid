...
//   	count=4;
    ...
    //   sqlmp = "Select location,camerapos,vehiclecode,snaptime from smartgrid.t_dispmapping where username='"+username+"' order by srno desc limit "+total+" ";

       
       ResultSet rs1 = st1.executeQuery(sqlmp);
	   
	   System.out.println("sqlmp Ajax1:-"+sqlmp);
...
// 			   dt1=dt.split("#");
 ...
 String sql5= "insert into smartgrid.t_dispmapping(location,camerapos,username,row,colval,vehiclecode,gridname)  values ('"+locationnew1[i]+"','cam1','"+username+"','2','2','"+vehcodee1[i]+"','"+gridname+"')";
...
System.out.println("sql5:-"+sql5);
     ...
     else
     {
    	 ...
    	 String sql5= "insert into smartgrid.t_dispmapping(location,camerapos,username,row,colval,vehiclecode,gridname)  values ('"+locationnew1[i]+"','cam1','"+username+"','1','2','"+vehcodee1[i]+"','"+gridname+"')";
      ...
      for(int i=0;i<total;i++)
       {
    	   ...
    	   sql = "Select * from smartgrid.t_jpgsnapsOnline where vehiclecode='"+vehiclecode1[i]+"' and camerapos='"+camerapos1[i]+"' order by snapdatetime desc limit 1";
   		...
   		String UpdateDissMap="update smartgrid.t_dispmapping set snaptime='"+rs.getString("snapdatetime")+"',rawfilename='"+rs.getString("rawfilename")+"',jpgfilename='"+rs.getString("jpgfilename")+"'  where vehiclecode='"+rs.getString("vehiclecode")+"' and camerapos='"+rs.getString("camerapos")+"' and username='"+username+"' and gridname='"+gridname+"'";

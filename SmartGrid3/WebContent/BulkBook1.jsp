...
<link rel="stylesheet" type="text/css" href="css/form.css" media="all">
    ...
    function showbox4()
    {
     ...
     i++;
       ...
       function Addloc()
       {
        	...
        	var action="add";
        	var position="1";
        	addloctobean(Country,State,city,loc,action,position);
       ...
       function addloctobean(country,state,city,loc,action,position)
       {
  var country1=country;
   ...
   var loc1=loc;
       	...
       	var queryString = "?country="+country1+"&state="+state1+"&city="+city1+"&loc="+loc1+"&action="+action+"&position="+position;
       	//alert(queryString);
       	ajaxRequest.open("GET", "AjaxAddloctobean.jsp" + queryString, true);
       	ajaxRequest.send(null); 
 ...
 /*       		} 
  ...
  <!--     <br><br><br><br><br><br> -->
	...
	<div class="styled-select slate">
			...
			<input type="button" value="Add"   onclick="Addloc1()">

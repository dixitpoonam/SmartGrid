...
if(country!="Select" || country!="Other"){
	sql = "SELECT Distinct(state) FROM smartgrid.t_countrycitystateinfo where country='"+country+"' Order by state asc ";
	...
	html+="<option value='Other'>Other State</option>";
}
 out.println("<option value='Select'>*Select State&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </option>"+html); 
}

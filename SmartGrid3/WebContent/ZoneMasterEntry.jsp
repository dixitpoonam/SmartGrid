...
//	alert(vehicle);
	...
	document.getElementById("myIframe").src="http://192.168.2.97:8080/birttest/frameset?__report=ZoneMaster.rptdesign&status="+Status+"&__showtitle=false";
...
<div class="absolute" align="center" id="">

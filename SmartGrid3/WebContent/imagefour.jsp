...
<br>
<br>
<div class="div1"  align="center" style="margin-bottom: 10px;" ><font color="black" size="3" face="Arial"><b>Camera Detail Report</b></font>
</div>
...
<div id="container"  >
    ...
    <div id="sliderFrame"><h2 style= "font:normal 16px Arial,Helvtica,sans-serif;visibility: hidden;"><b>label1</b></h2>
        ...
        <div  id="slider" style="outline:5px solid #000;"> 
        	...
        	if(request.getParameter("data")==null || request.getParameter("data1")==null){
        		sql = "Select vehiclecode,rawfilename,vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime between '"+new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new SimpleDateFormat("dd-MMM-yyyy HH:mm").parse(from))+"'  AND  '"+new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new SimpleDateFormat("dd-MMM-yyyy HH:mm").parse(to))+"'  AND camerapos in ('cam1') AND vehiclecode='"+type+"' Order by snapdatetime ASC";
        	...
        	// sql = "Select vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime >= '"+date1+time1+"' AND camerapos in ('cam1') AND snapdatetime <= '"+date2+time2+"'  AND vehicleregnumber='"+unitid+"' Order by snapdatetime ASC";
        	 ...
        	 sql = "Select vehiclecode,rawfilename,vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime  between '"+date1+time1+"'  AND '"+date2+time2+"' AND camerapos in ('cam1')    AND    vehiclecode='"+unitid+"' Order by snapdatetime ASC";
        	...
        	sql = "Select vehiclecode,rawfilename,vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime between '"+date1+time1+"' AND '"+date2+time2+"' AND camerapos in ('"+category+"') AND  vehiclecode='"+unitid+"' Order by snapdatetime ASC";
    		...
    		while(rs.next()){
    			 ...
    			 String  jpgfilename = rs.getString("rawfilename");
...
<img  src="https://s3.ap-south-1.amazonaws.com/smartgridinfra/<%=jpgfilename%>" width="350" height="260" />
    ...
    <div id="sliderFrame"><h2 style= "font:normal 16px Arial,Helvtica,sans-serif; visibility: hidden; margin-bottom: 10px;"><b>Camera 2</b></h2>
        ...
        <div id="slider1" style="outline:5px solid #000;">
        	...
        	if(request.getParameter("data")==null || request.getParameter("data1")==null){
        		...
        		sql1 = "Select vehiclecode,rawfilename,vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime between  '"+new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new SimpleDateFormat("dd-MMM-yyyy HH:mm").parse(from))+"'  AND '"+new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new SimpleDateFormat("dd-MMM-yyyy HH:mm").parse(to))+"' AND camerapos in ('cam2') AND vehiclecode='"+unitid+"' Order by snapdatetime ASC";
        	
        	}
        	else{
        		// sql = "Select unitid,jpgfilename,rawfiledatetime, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime >= '"+date1+time1+"' AND snapdatetime <= '"+date2+time2+"'  AND jpgfilename not like  '%pod%' "+condition+" Order by snapdatetime ASC";	
        	 sql1 = "Select vehiclecode,rawfilename,vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime between '"+date1+time1+"'  AND '"+date2+time2+"' AND camerapos in ('cam2')  AND vehiclecode='"+unitid+"' Order by snapdatetime ASC";
        	...
        	System.out.println("Inbellow else1");
        		//sql = "Select unitid,jpgfilename,rawfiledatetime, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime >= '"+date1+time1+"' AND snapdatetime <= '"+date2+time2+"' AND category in ('"+category+"') and type in ('"+type+"')  AND jpgfilename not like  '%pod%' "+condition+" Order by snapdatetime ASC";
        	sql1 = "Select vehiclecode,rawfilename,vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime   between '"+date1+time1+"' AND   '"+date2+time2+"' AND camerapos in ('"+category+"')  AND vehiclecode='"+unitid+"' Order by snapdatetime ASC";
        		}
    		...
    		while(rs1.next()){
    			...
    			String  jpgfilename1 = rs1.getString("rawfilename");
    			...
    			if(category.equals("cam1,cam2,cam3,cam4") || category.equals("cam2")){//out.println("http://smartgrid.mobile-eye.in/"+jpgfilename1);
       			...
       			<img  src="https://s3.ap-south-1.amazonaws.com/smartgridinfra/<%=jpgfilename1%>" width="350" height="260" />
         <%
    			}else{
    				%>
    ...
    <div id="sliderFrame"><h2 style= "font:normal 16px Arial,Helvtica,sans-serif;visibility: hidden;"><b>Camera 3</b></h2>
        ...
        <div id="slider2" style="outline:5px solid #000;"> 
        	...
        	if(request.getParameter("data")==null || request.getParameter("data1")==null){
        		...
        		sql3 = "Select vehiclecode,rawfilename,vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime between '"+new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new SimpleDateFormat("dd-MMM-yyyy HH:mm").parse(from))+"'  AND '"+new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new SimpleDateFormat("dd-MMM-yyyy HH:mm").parse(to))+"'  AND camerapos in ('cam3') AND  vehiclecode='"+unitid+"' Order by snapdatetime ASC";
        	 ...
        	 //sql3 = "Select vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime >= '"+date1+time1+"' AND camerapos in ('cam3') AND snapdatetime <= '"+date2+time2+"'  AND vehicleregnumber='"+unitid+"' Order by snapdatetime ASC";
        		...
        		sql3 = "Select vehiclecode,rawfilename,vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime between '"+date1+time1+"'  AND  '"+date2+time2+"'  AND vehiclecode='"+unitid+"' AND camerapos in ('cam3') Order by snapdatetime ASC";
        	...
        	sql3 = "Select vehiclecode,rawfilename,vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime between '"+date1+time1+"' AND  '"+date2+time2+"' AND camerapos in ('"+category+"')  AND vehiclecode='"+unitid+"' Order by snapdatetime ASC";
    		...
    		while(rs4.next()){
    			...
    			String  jpgfilename1 = rs4.getString("rawfilename");
    			...
    			//out.println("http://smartgrid.mobile-eye.in/"+jpgfilename1);
       			...
       			<img  src="https://s3.ap-south-1.amazonaws.com/smartgridinfra/<%=jpgfilename1%>" width="350" height="260" />
<%--        			<input type="text" name="abc" id="abc" value="https://s3.ap-south-1.amazonaws.com/smartgridinfra/<%=jpgfilename1%>"></input> --%>
         <%
    			}else{
    				%>
    ...
    <div id="sliderFrame"><h2 style= "font:normal 16px Arial,Helvtica,sans-serif; visibility: hidden;"><b>Camera 4</b></h2>
        ...
        <div id="slider3" style="outline:5px solid #000;">
        	...
        	if(request.getParameter("data")==null || request.getParameter("data1")==null){
        		...
        		sql4 = "Select vehiclecode,rawfilename,vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime between '"+new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new SimpleDateFormat("dd-MMM-yyyy HH:mm").parse(from))+"' AND '"+new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new SimpleDateFormat("dd-MMM-yyyy HH:mm").parse(to))+"' AND camerapos in ('cam4')  AND vehiclecode='"+unitid+"' Order by snapdatetime ASC";
        	...
        	sql4 = "Select vehiclecode,rawfilename,vehicleregnumber,unitid,jpgfilename, snapdatetime from smartgrid.t_jpgsnapsmartgrid where snapdatetime between '"+date1+time1+"' AND '"+date2+time2+"' AND camerapos in ('"+category+"') AND vehiclecode='"+unitid+"' Order by snapdatetime ASC";
        	}
    		...
    		while(rs5.next()){
    			...
    			String  jpgfilename3 = rs5.getString("rawfilename");
    			...
    			if(category.equals("cam1,cam2,cam3,cam4") || category.equals("cam4")){
       			...
       			<img  src="http://https://s3.ap-south-1.amazonaws.com/smartgridinfra/<%=jpgfilename3%>" width="350" height="260"  />
         <%
    			}else{
    				%>
